...
public class RotationPlace extends BlockPlaceCheck {
    ...
    public void onPostFlyingBlockPlace(BlockPlace place) {
        ...
        boolean hit = didRayTraceHitPost(place);
    ...
    private boolean didRayTraceHitPost(BlockPlace place) {
        ...
        for (double d : player.getPossibleEyeHeights()) {
            for (Vector3f lookDir : possibleLookDirs) {
                ...
                Pair<Vector, BlockFace> intercept = ReachUtils.calculateIntercept(box, trace.getOrigin(), trace.getPointAtDistance(distance), player, place.getMaterial());

                if (intercept.getFirst() != null) {
                    return true;
//                    interceptBlock = new Vector3i(intercept.getFirst().getBlockX(), intercept.getFirst()
//                        .getBlockY(), intercept.getFirst().getBlockZ());
//
//                    if (place.getPlacedAgainstBlockLocation().equals(interceptBlock)) {
//                        return true;
//                    }
                }
            }
        ...
        // flagAndAlert("placed-block-behind-wall");
        System.out.println("Stop hacking bozo");
        return false;
    }
