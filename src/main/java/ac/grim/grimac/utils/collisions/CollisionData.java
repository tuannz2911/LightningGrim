...
public enum CollisionData {
    ...
    // This does not include states where isSolid() == false which are automatically considered NoCollision unless specified otherwise
    NO_COLLISION(NoCollisionBox.INSTANCE,
            StateTypes.MOVING_PISTON, StateTypes.LIGHT),
